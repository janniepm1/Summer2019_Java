...
public class ArrayListReview {
    ...
    // size(): returns the total number of elements in the list ( similar with lenght method in array
        ...
        System.out.println( list.size() ); //4 total of elements
            // last index number: list.size()-1
        
        for(int i = 0; i < list.size(); i++) {//print the array one by one
            System.out.print(list.get(i)+" ");
        }
        
        System.out.println();//seperates lines
        
        for(int i = list.size()-1;  i >= 0; i--  ) {//reverse a string
            System.out.print(list.get(i)+" ");
        }
        System.out.println();
        ...
        list.clear();
        System.out.println(list);//empty array
        ...
        ArrayList<String> students = new ArrayList<>();
                ...
                students.set(0, "Holly");//set replace the index
                System.out.println(students);
